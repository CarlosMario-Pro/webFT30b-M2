...
Sabemos que los Componentes de React tienen que cumplir el principio de una sóla responsabilidad, es decir que cada Componente debe cumplir una sóla tarea bien definida. Los Componentes que vamos a codear son:
...
Este componente va a utilizarse para luego poder encontrar las ciudades sobre las cuales se desee ver el clima actual.
