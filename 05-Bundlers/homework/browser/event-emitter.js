  //window.EventEmitter = EventEmitter; se borra el window y no sé por qué
...
module.exports = EventEmitter;//Aquí se exporta y en el whiteboard se trae y se instanciia.
