  ...
  //window.whiteboard = neww window.EventEmitter()

  
  //let whiteboard = new EventEmitter();
  
  //let EventEmitter = require("./event-emitter.js");
  let eventEmitter = require("./event-emitter.js");//En el event.emitter se exporta y aquí se trae

  let whiteboard = new EventEmitter ();//En el event.emitter se exporta se instanciia.
...
modele.exports = whiteboard;
//even-emitter --->exporta
//--->whiteboard trae y crea una instancia, luego también este mismo se exporta